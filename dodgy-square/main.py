...
class DodgySquare:
    ...
    def show_game_over(self):
        ...
        exit_text = self.font.render("Press 'esc' to exit", True, self.WHITE)
        ...
        coordinates_game_over = (self.screen_width // 2 - text_width // 2, self.screen_height // 2 - text_height)
        coordinates_exit = (self.screen_width // 2 - text_width // 2, self.screen_height // 2)
        coordinates_restart = (self.screen_width // 2 - text_width // 2, self.screen_height // 2 + text_height)

        self.screen.blit(game_over_text, coordinates_game_over)
        self.screen.blit(exit_text, coordinates_exit)
        self.screen.blit(restart_text, coordinates_restart)
